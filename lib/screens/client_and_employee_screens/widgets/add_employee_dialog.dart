...
class _AddEmployeeDialogState extends State<AddEmployeeDialog> {
  ...
  void _addEmployee() {
    ...
    final newEmployee = Employee(
      id: DateTime.now().millisecondsSinceEpoch.toString().substring(0, 5),
      name: _nameController.text,
      position: _selectedPosition ?? 'Test',
      phoneNumber: _phoneController.text,
      photoUrl: _photoUrl ?? 'assets/logo/img.png', // To'g'ri ID
      email: _emailController.text,
      schedule: _selectedSchedule ?? '09:00-18:00',
      branch: _selectedBranch ?? 'Главный офис',
    );
